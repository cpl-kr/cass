...
public class EventSenderMouseDragged extends EventSenderMouse {

	public EventSenderMouseDragged(String sessionId, String windowId, WebSocket connection) {
	...
	public void sendEvent(String elementId, int x, int y, MouseButtonGui mouseButton, int clickCount,
		...
		String action = "M" + button + "D" + TRENNER + clicks + TRENNER + keys;
