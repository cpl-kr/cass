...
public class ImagesKlick extends ImagesGui {
	...
	public ImagesKlick(ImageView imageView, Image imageActive, Image imageInactive, Image imageMouseOver) {
		super(imageView);
	...
	public void addEventFilter(EventHandlerMouseClicked eventHandlerMouseClicked,
			...
			EventHandlerMousePressed eventHandlerMousePressed, EventHandlerMouseReleased eventHandlerMouseReleased,
