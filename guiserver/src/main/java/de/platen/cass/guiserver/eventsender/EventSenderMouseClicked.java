...
public class EventSenderMouseClicked extends EventSenderMouse {

	public EventSenderMouseClicked(String sessionId, String windowId, WebSocket connection) {
	...
	public void sendEvent(String elementId, int x, int y, MouseButtonGui mouseButton, int clickCount,
		...
		String action = "M" + button + "C" + TRENNER + clicks + TRENNER + keys;
